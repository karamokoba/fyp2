...
<html>
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/readingQ.css') }}"/>
    </head>
    <body>
        <div class="questions">
            <div class="div">
            <div class="group">
                ...
                <div class="frame">
                    <a href="/readingPaper"><div class="div-wrapper"><div class="text-wrapper">Back</div></div></a>
                </div>
                <div class="frame-wrapper">
                    <a href="/readingA"><div class="div-wrapper"><div class="text-wrapper">Next</div></div></a>
                </div>
                <div class="overlap">
                    <div class="text-wrapper-2">Questions</div>
                    <img class="photo" src="images/RQ.jpg" />
                </div>
