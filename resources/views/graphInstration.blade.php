...
<html>
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/graphInstration.css') }}"/>
    </head>
    <body>
        <div class="intruction-of-graph">
            <div class="div">
            <div class="group">
                ...
                <div class="overlap">
                    <div class="frame">
                        <a href="/lineGraph"><div class="div-wrapper"><div class="text-wrapper">Continue</div></div></a>
                    </div>
                    <div class="overlap-group">
                        <div class="circle-with-triangle">
                            <div class="polygon-wrapper"></div>
                        </div>
                        <img class="screenshot" src="images/GI.png" />
                    </div>
                ...
                <div class="text-wrapper-2">Graph Exam</div>
