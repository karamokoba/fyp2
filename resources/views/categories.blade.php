    ...
    <body>
        <div class="categories">
            ...
            <div class="group">
                ...
                <div class="frame">
                    <div class="group-2">
                        <a href="/lecturerCategories"><img class="lecturer-image" src="{{ asset('images/4444.jpg') }}" /></a>
                        <div class="reading">Lecturer</div>
                        <div class="overlap-group-wrapper">
                            <div class="overlap-group">
                                <a href="/instration"><img class="student-image" src="{{ asset('images/3333.jpg') }}" /></a>
                                <div class="reading">Student</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="text-wrapper">Choose Status</div>
