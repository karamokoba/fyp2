...
<html>
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/examcategories.css') }}" />
    </head>
    <body>
        ...
        <div class="group">
            ...
            <div class="overlap">
                <div class="frame">
                    <div class="">
                    <img class="img" src="images/iiii.jpg" />
                        <a href="/writingA"><div class="genre"><div class="text-wrapper">Writing</div></div></a>
                        <div class="overlap-group-wrapper">
                            <div class="overlap-group">
                            <a href="/readingA/showAll"><img class="img" src="images/reading-new.jpg" /></a>
                                <div class="text-wrapper">Reading</div>
                            </div>
                        </div>
                        <div class="overlap-wrapper">
                            <div class="overlap-group">
                            <a href="/graphAnswers"><img class="img" src="images/writing-bar-graph.jpg" /></a>
                                <div class="text-wrapper">Graph</div>
                            </div>
                        </div>
                    </div>
                    <!-- <div class="div-wrapper"><div class="text-wrapper-2">See Results</div></div> -->
